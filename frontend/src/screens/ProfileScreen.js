...
export default function ProfileScreen() {
  ...
  const submitHandler = (e) => {
    ...
    if (password !== confirmPassword) {
      ...
      else if (name.includes(" ")) {alert("Name field must not contain space");}
    else if (password.includes(" ")) {alert("Password field must not contain space");}
    else if (password.length<8) {alert("Password must be more than 8 characters")}
